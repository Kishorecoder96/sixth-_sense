...
class FaceEmotion():
    def __init__(self,voice_assistant):
        ...
        self.name = None
        self.emo = None
        self.interpreter = tf.lite.Interpreter("models/modelemotion.tflite")
    ...
    def detect_faces(self):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.putText(frame, self.emo, (x, y-5), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2, cv2.LINE_AA)
            ...
            self.found_name = self.name
            if self.found_name == 'Unknown':
                return False
            else:
                # print(f"{self.found_name} is in front of you and he is {self.emo}")
                self.voice_assistant.speak(f"{self.found_name} is in front of you and he is {self.emo}")
                return
